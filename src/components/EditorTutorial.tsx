...
const steps: TutorialStep[] = [
  ...
  {"id": "chat-references", "selector": "[data-tutorial=\"chat-references\"]", "title": "참고 이미지", "body": "참고 사진을 펼쳐 이미지를 최대 3장 추가합니다. 사진마다 분위기 또는 인물·제품 참고 용도를 지정하고, 접으면 대화를 넓게 볼 수 있어요."},
